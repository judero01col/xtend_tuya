...
CONSUMPTION_SENSORS: tuple[XTSensorEntityDescription, ...] = (
    ...
    XTSensorEntityDescription(
        key=XTDPCode.TODAY_ENERGY_ADD_2,
        translation_key="today_energy_add2",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        entity_registry_enabled_default=False,
    ...
    XTSensorEntityDescription(
     ...
     XTSensorEntityDescription(
        key=XTDPCode.ADD_ELE_1_THIS_MONTH,
        virtual_state=VirtualStates.STATE_SUMMED_IN_REPORTING_PAYLOAD,
        translation_key="add_ele_this_month",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    XTSensorEntityDescription(
        key=XTDPCode.ADD_ELE_1_THIS_YEAR,
        virtual_state=VirtualStates.STATE_SUMMED_IN_REPORTING_PAYLOAD,
        translation_key="add_ele_this_year",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
     ...
     XTSensorEntityDescription(
        key=XTDPCode.ADD_ELE_2_THIS_MONTH,
        virtual_state=VirtualStates.STATE_SUMMED_IN_REPORTING_PAYLOAD,
        translation_key="add_ele_this_month",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    XTSensorEntityDescription(
        key=XTDPCode.ADD_ELE_2_THIS_YEAR,
        virtual_state=VirtualStates.STATE_SUMMED_IN_REPORTING_PAYLOAD,
        translation_key="add_ele_this_year",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
     ...
     XTSensorEntityDescription(
        key=XTDPCode.ADD_ELE_1,
        virtual_state=VirtualStates.STATE_COPY_TO_MULTIPLE_STATE_NAME,
        vs_copy_delta_to_state=[XTDPCode.ADD_ELE_1_TODAY, XTDPCode.ADD_ELE_1_THIS_MONTH, XTDPCode.ADD_ELE_1_THIS_YEAR],
        translation_key="add_ele_1",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        entity_registry_enabled_default=False,
    ...
    XTSensorEntityDescription(
        key=XTDPCode.ADD_ELE_2,
        virtual_state=VirtualStates.STATE_COPY_TO_MULTIPLE_STATE_NAME,
        vs_copy_delta_to_state=[XTDPCode.ADD_ELE_2_TODAY, XTDPCode.ADD_ELE_2_THIS_MONTH, XTDPCode.ADD_ELE_2_THIS_YEAR],
        translation_key="add_ele_1",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
...
ELECTRICITY_SENSORS: tuple[XTSensorEntityDescription, ...] = (
    ...
    # cz
    XTSensorEntityDescription(
        key=XTDPCode.CUR_POWER_1,
        translation_key="power_1",
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
    ),
     XTSensorEntityDescription(
        key=XTDPCode.CUR_POWER_2,
